    ...
    <div class="relative flex min-h-svh flex-col items-center justify-center overflow-hidden p-6 md:p-10">
        ...
        <div class="flex w-full max-w-sm flex-col gap-8">
            ...
            <a href="{{ route('home') }}" wire:navigate class="flex flex-col items-center gap-3">
                <span
                    class="flex size-14 items-center justify-center rounded-2xl bg-linear-to-br from-brand-500 to-brand-700 text-white shadow-lg shadow-brand-500/30">
                    <x-app-logo-icon class="size-8" />
                </span>
                <span
                    class="font-display text-3xl leading-none text-zinc-900 dark:text-zinc-50">{{ config('app.name', 'Tasks (by Zendos') }}</span>
            </a>
